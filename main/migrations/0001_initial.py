# Generated by Django 5.2.1 on 2025-05-24 23:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notif_type', models.CharField(choices=[('verified', 'Property Verified'), ('favorite', 'Added to Favorites')], max_length=20)),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('is_read', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('rental', 'rental'), ('sale', 'sale')], default='rental', max_length=50)),
                ...
                ('property_type', models.CharField(choices=[('single room', 'single room'), ('self contained', 'self contained'), ('chamber & hall', 'chamber & hall'), ('apartment', 'apartment'), ('serviced appartment', 'serviced apartment'), ('duplex', 'duplex'), ('hostel', 'hostel'), ('guest house', 'guest house'), ('commercial', 'commercial')], default='apartment', max_length=100)),
                ('detailed_address', models.TextField()),
                ('status', models.CharField(choices=[('available', 'available'), ('rented', 'rented'), ('sold', 'sold')], default='available', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='properties', to='main.property')),
            ],
        ),
        migrations.CreateModel(
            name='PropertyReview',
